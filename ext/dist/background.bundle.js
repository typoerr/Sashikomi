...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getMemosByUrl = exports.remove = exports.save = exports.db = undefined;
	...
	* */
	var save = exports.save = function save(obj) {
	  var data = _util2.default.pick(obj, ['id', 'url', 'targetElm', 'contentText']);
	...
	* content_script内で配列分だけrenderするように使う
	...
	$getMemosByUrl('http//:example.co.jp')
	  ...
	  .catch(err => console.log(err));
	* */
	var getMemosByUrl = exports.getMemosByUrl = function getMemosByUrl(url) {
	  return db.transaction('rw', db.memos, function () {
