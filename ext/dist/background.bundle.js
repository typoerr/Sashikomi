...
/******/([
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    (function (setImmediate) {/* A Minimalistic Wrapper for IndexedDB
	   ====================================
      ...
      (function (global, publish, undefined) {
        ...
        function Dexie(dbName, options) {
          ...
          Object.defineProperty(this, "tables", {
            get: function () {
              ...
              return Object.keys(allTables).map(function (name) {
          ...
          // Events
          //
          this.on = events(this, "error", "populate", "blocked", {
            "ready": [promisableChain, nop],
            "versionchange": [reverseStoppableEventChain, nop]
          });
          ...
          this.transaction = function (mode, tableInstances, scopeFunc) {
            ...
            //
            var tables = Array.isArray(tableInstances[0]) ? tableInstances.reduce(function (a, b) {
              return a.concat(b);
            }) : tableInstances;
            var error = null;
          ...
          this.table = function (tableName) {
            ...
            if (!allTables.hasOwnProperty(tableName)) {
              ...
              return { AN_UNKNOWN_TABLE_NAME_WAS_SPECIFIED: 1 };
            }
        ...
        var Promise = (function () {
          ...
          var _asap = typeof setImmediate === 'undefined' ? function (fn, arg1, arg2, argN) {
            var args = arguments;
            setTimeout(function () {
              fn.apply(global, _slice.call(args, 1));
            }, 0); // If not FF13 and earlier failed, we could use this call here instead: setTimeout.call(this, [fn, 0].concat(arguments));
        ...
        };// Will never be changed. We just fake for the IDE that we change it (see doFakeAutoComplete())
        ...
        // AMD:
        true ?
          [self || window, function (name, value) {
