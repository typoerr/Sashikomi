...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.$getMemosByUrl = exports.$delete = exports.$put = exports.db = undefined;
	...
	* */
	var $put = exports.$put = function $put(obj) {
	...
	* 存在しないIDが渡されても例外は起きない。なにも起きない。
	...
	$delete(2)
	  ...
	  .catch(err => console.log(err));
	* */
	var $delete = exports.$delete = function $delete(obj) {
	  var id = obj.id || -1;
	  return db.transaction('rw', db.memos, function () {
