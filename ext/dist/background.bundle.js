...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var putMemo = function putMemo(obj) {
	  var locationData = _util2.default.pick(obj, ['id', 'url']);
	  var contentData = _util2.default.omit(obj, ['id', 'url']);
	
	  return db.transaction('rw', db.locations_table, db.contents_table, function () {
	    ...
	    .then(function (id) {
	      var data = Object.assign({}, contentData, { locationId: id });
	    ...
	    .then(function (contentPrimaryKey) {
	      return db.contents_table.get(contentPrimaryKey);
	    });
	  }).then(function (content) {
	    return db.locations_table.get(content.locationId, function (location) {
	...
	putMemo(exist_memo).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var SetCache = __webpack_require__(10),
	    arrayIncludes = __webpack_require__(12),
	    arrayIncludesWith = __webpack_require__(13),
	    arrayMap = __webpack_require__(14),
	    baseFlatten = __webpack_require__(15),
