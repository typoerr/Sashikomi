...
/***/ function(module, exports, __webpack_require__) {
	...
	_database.db.putMemo(new_memo).then(function (data) {
	...
	* ------------------------------------*/
	...
	var DB = function () {
	  ...
	  _createClass(DB, [{
	    ...
	    key: 'putMemo',
	    value: function putMemo(obj) {
	      var _this = this;
	
	      return this.db.transaction('rw', this.db.memos, function () {
	        return _this.db.memos.put(obj).then(function (id) {
	          return _this.db.memos.get(id);
	        });
	      });
	    }
	  }, {
	    key: 'deleteMemo',
	    value: function deleteMemo(id) {
	      var _this2 = this;
	
	      return this.db.transaction('rw', this.db.memos, function () {
	        return _this2.db.memos.delete(id);
	      });
	    }
	  }, {
	    key: 'getMemosByUrl',
	    value: function getMemosByUrl(url) {
	      var _this3 = this;
	
	      return this.db.transaction('rw', this.db.memos, function () {
	        return _this3.db.memos.where('url').equals(url).toArray();
	      });
	    }
	  }]);
