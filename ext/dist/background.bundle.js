...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getMemosByUrl = exports.deleteMemo = exports.putMemo = exports.db = undefined;
	...
	* */
	var putMemo = exports.putMemo = function putMemo(obj) {
	...
	* 存在しないIDが渡されても例外は起きない。なにも起きない。
	...
	deleteMemo(2)
	  ...
	  .catch(err => console.log(err));
	* */
	var deleteMemo = exports.deleteMemo = function deleteMemo(obj) {
	  var id = obj.id || -1;
	  return db.transaction('rw', db.memos, function () {
